       ...
       <div id="MenuBar">
        ...
        <div id="parent"> 
            ...
            <div class="profile">
                ...
                <input type="text" class="profileText" id="fname" value="Batool" disabled> <br>
                <label>Last Name:</label>
                <input type="text" class="profileText" id="lname"  value="Almusawi" disabled> <br>
                <label>Email:</label>
                <input type="text" class="profileText" id="email"  value="bamm-20111@hotmail.com" disabled> <br><br>
                <input type="submit" id="update" value="Update" onclick="myFunction()" /> 
                <button id="updatePass"  onclick="window.location.href='http://localhost:8383/My%20Health%20from%20A%20to%20Z/UpdatePasswordPage.html';">Update Password</button>
            </div>  
