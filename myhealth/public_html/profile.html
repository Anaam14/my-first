       ...
       <div id="MenuBar">
        ...
        <div id="parent"> 
            <div class="profile">
                ...
                Email: <input type="text" id="email"  value="" disabled> <br><br>
                <input type="submit" id="update" value="Update" onclick="myFunction()" /> 
                <button onclick="window.location.href='http://localhost:8383/My Health from A to Z/UpdatePasswordPage.html';">Update Password</button>
            </div>  
